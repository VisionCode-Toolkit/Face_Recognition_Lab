...
class Face_detector():
    ...
    def __int__(self, output_image_viewer):
    ...
    def apply_face_detection(self):
        original_image = self.output_image_viewer.current_image.modified_image
        ...
        detected_faces = self.face_cascade.detectMultiScale(self.output_image_viewer.current_image.modified_image, 1.3, 5)

        self.output_image_viewer.current_image.modified_image = self.draw_rects_on_faces(original_image,detected_faces )
